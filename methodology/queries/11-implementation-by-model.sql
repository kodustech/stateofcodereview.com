-- Implementation rate by exact LLM model identifier.
-- Models with fewer than 80 delivered suggestions are excluded.
-- Rows with orgs = 1 carry a sample-size caveat in the published report
-- (one customer can have idiosyncratic prompt configuration that skews results).
